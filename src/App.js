...
function App() {
      ...
      try {
        const [cartResponse, favoritesResponse, itemsResponse] =
          await Promise.all([
            ...
            axios.get("https://64df954e71c3335b2582d6fd.mockapi.io/favorites"),
  ...
  const onRemoveItem = (id) => {
    try {
      axios.delete(`https://64df954e71c3335b2582d6fd.mockapi.io/cart/${id}`);
      setCartItems((prev) =>
  ...
  const onAddToFavorite = async (obj) => {
    try {
      if (favorites.find((favObj) => Number(favObj.id) === Number(obj.id))) {
        axios.delete(
          `https://64df954e71c3335b2582d6fd.mockapi.io/favorites/${obj.id}`
        );
        setFavorites((prev) =>
        ...
        const { data } = await axios.post(
          "https://64df954e71c3335b2582d6fd.mockapi.io/favorites",
          obj
        );
